...
<head>
    ...
    <title>Vendor Login — ChashiBondhu</title>
    ...
    <section class="min-h-screen flex items-center justify-center px-6 py-28">
        <div class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div class="bg-amber-900 p-10 flex flex-col justify-between text-white">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold leading-tight mb-4">
                        Welcome Back,<br><span class="text-amber-400">Vendor</span>
                    </h2>
                    <p class="text-amber-200 text-sm leading-relaxed">
                        Log in to manage your tools, equipment listings and track your sales across Bangladesh.
                    </p>
                </div>

                <div class="space-y-4 mt-10">
                    <div class="flex items-center gap-3 bg-amber-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-box text-amber-400 w-5 text-center"></i>
                        <span class="text-amber-100 text-sm">Manage your tool listings</span>
                    </div>
                    <div class="flex items-center gap-3 bg-amber-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-chart-line text-amber-400 w-5 text-center"></i>
                        <span class="text-amber-100 text-sm">Track orders and sales</span>
                    </div>
                    <div class="flex items-center gap-3 bg-amber-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-comments text-amber-400 w-5 text-center"></i>
                        <span class="text-amber-100 text-sm">Connect with farmers directly</span>
                    </div>
                </div>
            ...
            <div class="bg-white p-10 flex flex-col justify-center">
                <div class="mb-8">
                    <span class="inline-block bg-amber-100 text-amber-700 text-xs font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-3">Vendor Portal</span>
                ...
                <form action="vendorLoginSubmit.php" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="vendorPassword" placeholder="Enter your password" required
                            ...
                            <button type="button" onclick="togglePassword('vendorPassword', 'vendorEye')"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-600">
                                <i id="vendorEye" class="fa-solid fa-eye text-sm"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-right-to-bracket"></i> Login as Vendor
                    </button>

                    <p class="text-center text-stone-400 text-sm">
                        Don't have an account?
                        <a href="vendorReg.php" class="text-amber-600 font-bold hover:text-amber-800 transition">Register here</a>
                    </p>
