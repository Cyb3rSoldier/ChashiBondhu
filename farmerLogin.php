    ...
    <section class="min-h-screen flex items-center justify-center px-6 py-28">
        <div class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div class="bg-green-900 p-10 flex flex-col justify-between text-white">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold leading-tight mb-4">
                        Welcome Back,<br><span class="text-green-400">Farmer</span>
                    </h2>
                    <p class="text-green-200 text-sm leading-relaxed">
                        Log in to manage your products, track your orders and connect directly with consumers across Bangladesh.
                    </p>
                </div>

                <div class="space-y-4 mt-10">
                    <div class="flex items-center gap-3 bg-green-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-box text-green-400 w-5 text-center"></i>
                        <span class="text-green-100 text-sm">Manage your product listings</span>
                    </div>
                    <div class="flex items-center gap-3 bg-green-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-chart-line text-green-400 w-5 text-center"></i>
                        <span class="text-green-100 text-sm">Track orders and earnings</span>
                    </div>
                    <div class="flex items-center gap-3 bg-green-800/60 rounded-2xl px-4 py-3">
                        <i class="fa-solid fa-comments text-green-400 w-5 text-center"></i>
                        <span class="text-green-100 text-sm">Chat directly with consumers</span>
                    </div>
                </div>
            ...
            <div class="bg-white p-10 flex flex-col justify-center">
                <div class="mb-8">
                    <span class="inline-block bg-green-100 text-green-700 text-xs font-bold tracking-widest uppercase px-3 py-1 rounded-full mb-3">Farmer Portal</span>
                ...
                <form action="farmerLoginSubmit.php" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="farmerPassword" placeholder="Enter your password" required
                            ...
                            <button type="button" onclick="togglePassword('farmerPassword', 'farmerEye')"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-600">
                                <i id="farmerEye" class="fa-solid fa-eye text-sm"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-right-to-bracket"></i> Login as Farmer
                    </button>

                    <p class="text-center text-stone-400 text-sm">
                        Don't have an account?
                        <a href="farmerReg.php" class="text-green-600 font-bold hover:text-green-800 transition">Register here</a>
                    </p>
                    ...
                    <div class="border-t border-stone-100 pt-4 text-center">
                        ...
                        <a href="consumerLogin.php"
                            ...
                            <i class="fa-solid fa-user"></i> Switch to Consumer Login
                        </a>
                    </div>
