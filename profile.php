...
$farmerEmail = $_SESSION['farmer_email'];
?>
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div class="space-y-4">
                <div class="border-b border-stone-100 pb-3">
                    ...
                    <p class="text-lg font-semibold text-green-950"><?php echo htmlspecialchars($farmerName); ?></p>
                </div>
                
                <div class="border-b border-stone-100 pb-3">
                    <p class="text-xs text-stone-400 uppercase tracking-wider">Email Address</p>
                    <p class="text-lg font-semibold text-green-950"><?php echo htmlspecialchars($farmerEmail); ?></p>
                </div>
            </div>
            
            <div class="mt-8">
                <a href="farmerDash.php" class="inline-flex items-center gap-2 text-green-600 hover:text-green-800 transition">
